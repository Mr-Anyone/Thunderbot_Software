 ...
 */
std::vector<Point> rasterize(const Tbots::Rectangle &rectangle, double resolution_size);
 ...
 */
std::vector<Point> rasterize(const Tbots::Polygon &polygon, double resolution_size);
