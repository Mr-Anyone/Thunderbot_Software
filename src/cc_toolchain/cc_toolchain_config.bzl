...
def _windows_cygwin_impl(ctx): 
    tool_paths = [
        tool_path(
            name = "gcc",
            path = "C:/cygwin64/bin/gcc",
        ),
        tool_path(
            name = "ld",
            path = "C:/cygwin64/bin/ld",
        ),
        tool_path(
            name = "ar",
            path = "C:/cygwin64/bin/ar",
        ),
        tool_path(
            name = "cpp",
            path = "C:/cygwin64/bin/false",
        ),
        tool_path(
            name = "gcov",
            path = "C:/cygwin64/bin/false",
    ...
    return cc_common.create_cc_toolchain_config_info(
        ...
        cxx_builtin_include_directories  = [
            # a way to get bazel to stop complaining
            "C:/cygwin64/bin",
        ],

        # see here for more: https://stackoverflow.com/questions/66587853/how-can-i-specify-the-expected-file-extension-generated-by-bazel-cc-binary-rule
        artifact_name_patterns = [
            artifact_name_pattern(
...
windows_cygwin_config = rule(
    implementation = _windows_cygwin_impl,
    attrs = {},
    provides = [CcToolchainConfigInfo],
)